...
*“ R’DASH (Robot Information Telemetry Transport Dashboard) is an open-source, cross-platform dashboard for real-time robot data visualization - developed and maintained by [Vamsi Karnam](https://www.linkedin.com/in/saivamsikarnam/) ”*
...
graph LR
  ...
  A1A2
  A2B[rdash Agent (rclpy)]
  BHTTP/HTTPS: /api/push, /api/push_image, /api/push_tf| C[rdash App (Flask + Socket.IO)]
